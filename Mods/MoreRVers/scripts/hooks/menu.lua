...
local function display_menu(mod)
  ...
  print("  Type 'MoreRVers.Help' in console for full command list")
  print("  Examples: MoreRVers.SetSpeed 50, MoreRVers.ToggleSpeed")
  print("  Categories: Speed, Vehicle, FallDamage, Revive, Throw, Heal")
  print("========================================")
  print("")
end
